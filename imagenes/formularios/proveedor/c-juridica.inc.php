...
$f->campos['rut'] = $f->text('rut', '', '16', 'required', false, false, "", "identificacion", true);
$f->campos['digito'] = $f->text('digito', '', '1', 'required', false, false, "", "numero", true);
$f->oculto("persona", "02");
$f->campos['dpersona'] = $f->text('dpersona', 'Persona Juridica', '', 'required', true, false, "");

$f->campos['razon'] = $f->text('razon', '', '128', 'required', false, false, "", "", true);
$f->campos['representante'] = $f->text('representante', "", '254', 'required', false, false, "");
$f->campos['identificacion'] = $f->text('identificacion', "", '254', 'required', false, false, "");
$f->campos['cargo'] = $cargos->combo("cargo", "", "required");

//$f->campos['razon'] = $f->text('proveedor', '', '128', '', false, false, "");
$f->campos['direccion'] = $f->text('direccion', '', '128', 'required', false, false, "");
$f->campos['pais'] = $paises->combo('pais' . $transaccion, "", "required");
$f->campos['region'] = $regiones->combo('region' . $transaccion, "", "", "required");
$f->campos['ciudad'] = $ciudades->combo('ciudad' . $transaccion, "", "", "", "required");
$f->campos['telefono'] = $f->text('telefono', '', '128', '', false, false, "required");
$f->campos['fax'] = $f->text('telefono', '', '128', '', false, false, "");
$f->campos['movil'] = $f->text('telefono', '', '128', '', false, false, "");
$f->campos['email'] = $f->text('email', '', '128', '', false, false, "", "email", true);
