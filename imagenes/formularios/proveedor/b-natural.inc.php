...
$f->campos['rut']=$f->text('rut','','16','required',false,false,"");
...
$f->campos['email']=$f->text('email','','128','',false,false,"");
...
<script type="text/javascript">
  MUI.resizeWindow($('<?php echo($f->ventana); ?>'), {width: 640, height: 380, top: 0, left: 0});
