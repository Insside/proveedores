...
// Form Window
  ...
  MUI.AcercaDe = function() {
   var transaccion = (new Date()).valueOf();
   var url = MUI.path.proveedores + 'bienvenidos.xhr.php?transaccion=' + transaccion;
   new MUI.Window({
    id: 'v' + transaccion,
  ...
  MUI.Terminos = function() {
   var transaccion = (new Date()).valueOf();
   var url = MUI.path.proveedores + 'terminos.xhr.php?transaccion=' + transaccion;
   new MUI.Modal({
    id: 'v' + transaccion,
    title: 'Proveedores - Portal De Servicios - Aguas De Buga S.A. E.S.P',
    icon: 'images/icons/16x16/page.gif',
    loadMethod: 'xhr',
    contentURL: url,
...
// Build windows onLoad
 ...
 initializeColumns = function() {
  ...
  new MUI.Panel({
   ...
   contentURL: MUI.path.proveedores + 'componentes.xhr.php', column: 'sideColumn1',
   headerToolbox: true,
   headerToolboxURL: MUI.path.proveedores + 'componentes.toolbox.xhr.html',
   padding: {top: 0, bottom: 0, left: 0, right: 0},
   require: {
...
// Add panels to main column
  new MUI.Panel({
   ...
   title: 'i:MIS',
   padding: {top: 0, bottom: 0, left: 0, right: 0},
   contentURL: 'modulos/proveedores/inicio.xhr.php',
   column: 'mainColumn',
   footer: true
       //headerToolbox: true,
...
// Agrega los paneles a la segunda columna
  new MUI.Panel({
   ...
   contentURL: MUI.path.proveedores + 'complementos.xhr.php', column: 'sideColumn2',
   padding: {top: 0, bottom: 0, left: 0, right: 0},
